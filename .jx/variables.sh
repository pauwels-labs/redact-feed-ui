...
export JENKINS_X_URL='https://dashboard.dev.pauwelslabs.com/pauwels-labs/redact-feed-ui/main/5'
...
export MINK_IMAGE='274295908850.dkr.ecr.eu-west-1.amazonaws.com/pauwels-labs/redact-feed-ui:0.0.5'
